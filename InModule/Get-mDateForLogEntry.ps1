function Get-mDateForLogEntry {
	...
	<#
	.SYNOPSIS
		Returns a date in string format for general use, such as log entries.

    .DESCRIPTION
		The format is "YYYY-MM-DD HH:MM:SS".

    .EXAMPLE
		PS> Get-mDateForLogEntry
		2024-06-20 09:55:27
	...
	.LINK
		https://github.com/companyname-Platform-Services/mPowerShellGenerics/blob/main/InModule/Get-mDateForLogEntry.ps1
